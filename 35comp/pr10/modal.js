class Modal extends HTMLElement {
  constructor() {
    ...
    //   console.log(
    //     "Cancelled on custom event inside the class, two handlers here"
    //   );
    // });
  }
  ...
  _cancel(e) {
    this.hide();
    const canceledEvent = new Event("cancel", {
      bubbles: true,
      composed: true,
    });
    e.target.dispatchEvent(canceledEvent);
  }
  _confirm() {
    this.hide();
    const confirmedEvent = new Event("confirm");
